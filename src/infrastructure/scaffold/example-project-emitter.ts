...
const VALIDATION_BARREL_SOURCE = [
  "// Stable home of the package's `./validation` export — module schemas may",
  "// move; this path may not (the ui's UForm imports through it).",
  'export { addQuoteRequest } from "./modules/quotes/quotes-validation.js";',
  "",
].join("\n");
...
/* ─── module wiring (golden's NotesModule analogue) ────────────────────────── */

const QUOTES_MODULE_SOURCE = [
